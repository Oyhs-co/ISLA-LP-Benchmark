"""
Solver Symphony para problemas de programacion lineal.
Implementacion usando Pyomo como interfaz a Symphony (COIN-OR).
"""
...
class SymphonySolver(BaseSolver):
    """Solver Symphony para problemas de programacion lineal.
    ...
    def solver_version(self) -> str:
        try:
            ...
            opt = SolverFactory("symphony")
            return getattr(opt, "version", "symphony")
        except Exception:
            return "symphony (not available)"
    ...
    def solve(self) -> Solution:
        """Resuelve el problema usando Symphony.
        ...
        try:
            ...
            if not opt.available(exception_flag=False):
                return Solution(
                    status="ERROR: Symphony solver executable not found",
                    objective_value=None,
                    variables={},
                )
