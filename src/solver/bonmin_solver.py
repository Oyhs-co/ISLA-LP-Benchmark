"""
Solver Bonmin para problemas de programacion lineal.
Implementacion usando Pyomo como interfaz a Bonmin (COIN-OR).
"""
...
class BonminSolver(BaseSolver):
    ...
    def solver_version(self) -> str:
        try:
            ...
            return getattr(opt, "version", "bonmin")
        except Exception:
            return "bonmin (not available)"
    ...
    def solve(self) -> Solution:
        """Resuelve el problema usando Bonmin.
        ...
        try:
            ...
            if not opt.available(exception_flag=False):
                return Solution(
                    status="ERROR: Bonmin solver executable not found",
                    objective_value=None,
                    variables={},
                )
            ...
            if term == pyo.TerminationCondition.optimal:
                ...
                status = "TIME_LIMIT"
            elif term == pyo.TerminationCondition.maxIterations:
